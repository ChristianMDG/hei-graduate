package com.heigraduate.app.endpoint.event.consumer;

import com.heigraduate.app.PojaGenerated;
import com.heigraduate.app.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.heigraduate.app.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.heigraduate.app.service.event."
